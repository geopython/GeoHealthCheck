...
def upgrade():
    ...
    op.create_index(op.f('ix_probe_vars_resource_identifier'), 'probe_vars', ['resource_identifier'], unique=False)
    op.add_column('resource', sa.Column('fs', sa.Integer(), nullable=True))
    op.create_index(op.f('ix_resource_owner_identifier'), 'resource', ['owner_identifier'], unique=False)
    op.create_index(op.f('ix_resource_tags_resource_identifier'), 'resource_tags', ['resource_identifier'], unique=False)
    op.create_index(op.f('ix_resource_tags_tag_id'), 'resource_tags', ['tag_id'], unique=False)
    op.create_index(op.f('ix_run_resource_identifier'), 'run', ['resource_identifier'], unique=False)
